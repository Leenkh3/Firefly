...
function(do_fetch)
  ...
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
...
execute_process(
  COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git show-ref "10.1.1"
  WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
...
execute_process(
  COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt'."
    ...
    execute_process(
      COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
    )
    execute_process(
      COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt"
      )
      execute_process(
        COMMAND "/cvmfs/software.eessi.io/versions/2023.06/compat/linux/x86_64/usr/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/work/students/hpc-bvrhib/firefly/fmt-test/build/fmt-prefix/src/fmt'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
