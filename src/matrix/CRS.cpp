...
CRS::CRS(std::vector<int> &connectivity, int shape_points) {
 ...
 void CRS::reshape(int rows, int cols){};           
 void CRS::T() {};                                   
 void CRS::mult(std::vector<double> &vec) {};           
 void CRS::print() {
 ...
 double& CRS::at(int row, int col) {
    double test=0.0;
    return test;
 };   
 std::vector<int> CRS::shape() {
    return this->cols;
 };
